...
myStartupHook = do
  ...
  spawn ("sleep 2 && trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --alpha 0 " ++ colorTrayer ++ " --height 22")
...
myLayoutHook = avoidStruts
  ...
  where
    myDefaultLayout = withBorder myBorderWidth tall
                                           ...
                                           ||| withBorder myBorderWidth tallAccordion
                                           ||| withBorder myBorderWidth wideAccordion
...
myKeys c =
  ...
  , ("M-S-<Return>", addName "Move focused window to master"  $ promote)
